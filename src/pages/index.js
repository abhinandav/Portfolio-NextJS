    ...
    <>
      ...
      <main className='flext items-center text-dark w-full  min-h-screen dark:text-light ' >
        ...
        <div className='flex items-center justify-between w-full  lg:flex-col'>
          ...
          <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
            ...
            <div className='flex items-center self-start mt-2 lg:self-center'>
              <Link href="abhinand.pdf" target={"_blank"}
              className='flex items-center bg-dark text-light p-2.5 px-6
              rounded-lg text-lg font-semibold
              hover:bg-light hover:text-black
              border-2 border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark hover:dark:text-light hover:dark:bg-dark
              hover:dark:border-light md:p-2 md:px-4 md:text-base'
              download={true}
              >Resume <LinkArrow className={"w-6 ml-1"}/>
              </Link>

              <Link href="mailto:abhinandorg3@gmail.com" target={"_blank"}
       ...
       <div className='absolute right-8 bottom-8 inline-block w-24 md:hidden'>
        <Image src={LightBulb} alt='lightbulb'  className='w-full h-auto md'/>
       </div>
      </main>
    </>
  )
